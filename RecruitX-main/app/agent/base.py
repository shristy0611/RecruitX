...
class BaseAgent(BaseModel, ABC):
    ...
    def __init__(self, **data):
        ...
        self.use_cache = True
        self.cache_ttl = 3600 * 24 * 7  # 1 week default
    ...
    async def ask(self, user_input: str) -> str:
        """
        Send a message to the agent to process and get a response.
    ...
    async def cache_api_response(
        ...
        """
        Cache API response in the database.
        
        Args:
            api_name: Name of the API
            request_data: Request data dict
            response_data: Response data string
            ttl_seconds: Time-to-live in seconds (default: 1 week)
        """
    ...
    async def get_cached_api_response(
        ...
        """
        Get cached API response from the database.
        ...
        Returns:
            Cached response or None if not found or caching disabled
        """
        if not self.use_cache:
            return None
        ...
        try:
            ...
            logger.warning(f"Failed to get cached API response: {e}")
            return None
